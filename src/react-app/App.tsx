...
import { Users, Building2, MapPin, Briefcase, TrendingUp, Activity, ChevronDown, Filter, Search, Download, Grid, BarChart3, PieChartIcon, Eye, EyeOff, Table, RefreshCw, Maximize2, X, ChevronRight, Layers, Database, ArrowRight } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center text-red-400">
          <p className="text-xl">Error loading data. Please ensure all CSV files are available.</p>
        </div>
      </div>
    );
  }
